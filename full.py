        ...
        for line in lines:
          ...
          if len(data) > 0:
            try:
              ...
              anus = bs(ses.get(anu, timeout=10, verify=False).text, 'html.parser').findAll('input')
              anu2 = 'https://my.its.ac.id/signin?response_type=code&redirect_uri=https%3A%2F%2Fmy.its.ac.id%2Fsso%2Fauth&client_id=8F7FA330-B0AF-4D91-9EC4-1A4182336EEC&nonce=5b39931a561d6dfcba0f38f2366de65f&state=f453c2edb78bf8e817d6ad204caeb3d6&scope=openid+integra+profile+email+phone+group+role+resource'
              prams = {
